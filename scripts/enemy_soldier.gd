...
# Вражеский солдат — атакует только юнитов игрока
...
func _on_enemy_entered(body):
	if body.has_method("take_damage") and body.is_in_group("player_units") and body not in enemies_in_range:
...
func _attack_target():
	if current_target.has_method("take_damage"):
		...
		print("EnemySoldier атакует игрока! Урон: ", attack_damage)
...
func take_damage(damage: int):
	...
	if health <= 0:
		...
		print("EnemySoldier получил урон: ", damage, ". Здоровье: ", health) 